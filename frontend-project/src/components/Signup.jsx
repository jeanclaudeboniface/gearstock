    ...
    >
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="space-y-3">
          <label className="block text-xs font-bold text-slate-500 uppercase tracking-wider mb-1">Company Details</label>
        ...
        <div className="space-y-3">
          <label className="block text-xs font-bold text-slate-500 uppercase tracking-wider mb-1">Admin Account</label>
          <div className="space-y-3">
            <input
              name="ownerName"
              type="text"
